...
meta_data:
  title: "Graphite Studio Brand Identity"
  description: "Crafted a vibrant brand identity for Graphite Studio, including logo design and responsive website. Concept inspired by graphite's role in creativity, driving business growth."
...
<InfoTextColumns data={{
    ...
    TOOL: "Sketch, Adobe Illustrator, Adobe Photoshop",
    YEAR: "2020-2021",
  }}
/>
