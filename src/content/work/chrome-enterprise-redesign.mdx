...
<InfoTextColumns data={{
    ROLE: "Tech Lead" ,
    COMPANY: "Huge / Google" ,
    TOOL: "Webpack, NodeJS, Figma API, Webpack, TypeScript, SASS/CSS, CSS Custom Properties, GSAP, HTML, Python/Flask, CMS (Internal) , Google Analytics, Intersection Observer",
    YEAR: "2020-2022",
  }}
/>
