...
<InfoTextColumns data={{
    ROLE: "Tech Lead" ,
    COMPANY: "Huge / Google" ,
    TOOL: "Webpack, NodeJS, Figma API, TypeScript, SASS/CSS, CSS Custom Properties, GSAP, HTML, Python/Flask, CMS (Internal) , Google Analytics, Intersection Observer, Figma",
    YEAR: "2020-2022",
  }}
/>
