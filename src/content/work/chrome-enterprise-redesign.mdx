...
<InfoTextColumns data={{
    ROLE: "Tech Lead" ,
    COMPANY: "Huge / Google" ,
    TOOL: "TypeScript, SASS/CSS, CSS Custom Properties, GSAP, Anime.js, HTML, Figma,Figma API, Webpack, NodeJS,  Python/Flask, CMS (Internal) , Google Analytics, Intersection Observer",
    YEAR: "2020-2022",
  }}
/>
